...
public:
	...
	TDelegate<void(const TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles; // 0x0250(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPrivate)
	UMulticastDelegateProperty_                   OnAudioFinished;                                   // 0x0260(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
	UMulticastDelegateProperty_                   OnAudioPlaybackPercent;                            // 0x0270(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
...
{
public:
	struct FMovieSceneSkeletalAnimationParams     Params_0;                                          // 0x00E0(0x00D0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
