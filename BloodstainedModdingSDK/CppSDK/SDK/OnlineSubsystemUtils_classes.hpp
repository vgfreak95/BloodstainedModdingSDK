...
public:
	...
	class UNetDriver*                             NetDriver;                                         // 0x0498(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	class AOnlineBeaconHostObject*                BeaconOwner;                                       // 0x04B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNetConnection*                         BeaconConnection;                                  // 0x04C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x04C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
public:
	...
	TSubclassOf<class AOnlineBeaconClient>        ClientBeaconActorClass;                            // 0x0498(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x04A0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	TArray<class FName>                           CompatibleUniqueNetIdTypes;                        // 0x0030(0x0010)(ZeroConstructor, Config, NativeAccessSpecifierPrivate)
	TMap<class FName, class FName>                MappedUniqueNetIdTypes;                            // 0x0040(0x0050)(ZeroConstructor, Config, NativeAccessSpecifierPrivate)
...
public:
	...
	class FString                                 DestSessionId;                                     // 0x0538(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FPartyReservation                      PendingReservation;                                // 0x0548(0x0040)(Protected, NativeAccessSpecifierProtected)
	EClientRequestType                            RequestType;                                       // 0x0588(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bPendingReservationSent;                           // 0x0589(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCancelReservation;                                // 0x058A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_58B[0x2D];                                     // 0x058B(0x002D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UPartyBeaconState*                      State;                                             // 0x04B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
