 ...
 *	- THe 'GWorld' offset is not used by the SDK, it's just there for "decoration", use the provided
 * 'UWorld::GetWorld()' function instead
 */
namespace Offsets {
constexpr int32 GObjects = 0x0B2FA380;
constexpr int32 AppendString = 0x074A8480;
constexpr int32 GNames = 0x0B2F4458;
constexpr int32 GWorld = 0x0B41FB98;
constexpr int32 ProcessEvent = 0x0764B060;
...
// Forward declarations because in-line forward declarations make the compiler think 'GetStaticClass()' is a class
// template
class UClass;
class UObject;
class UFunction;
...
class TUObjectArray final {
   public:
    static constexpr auto DecryptPtr = [](void* ObjPtr) -> uint8* { return reinterpret_cast<uint8*>(ObjPtr); };
...
class TUObjectArrayWrapper {
   ...
   public:
    inline void InitManually(void* GObjectsAddressParameter) { GObjectsAddress = GObjectsAddressParameter; }
    ...
    inline TUObjectArray& operator*() const { return *reinterpret_cast<class TUObjectArray*>(GObjectsAddress); }
...
class FName final {
   ...
   public:
    ...
    static void InitManually(void* Location) { AppendString = reinterpret_cast<void*>(Location); }
    ...
    bool IsNone() const { return !ComparisonIndex && !Number; }
    ...
    std::string GetRawString() const {
        ...
        if (!AppendString) InitInternal();

        InSDKUtils::CallGameFunction(reinterpret_cast<void (*)(const FName*, FString&)>(AppendString), this,
                                     TempString);
    ...
    std::string ToString() const {
        ...
        if (pos == std::string::npos) return OutputString;
...
class FText final {
   ...
   public:
    const class FString& GetStringRef() const { return TextData->TextSource; }
    std::string ToString() const { return TextData->TextSource.ToString(); }
};
...
class TWeakObjectPtr : public FWeakObjectPtr {
   public:
    ...
    UEType* operator->() const { return static_cast<UEType*>(FWeakObjectPtr::Get()); }
};
...
struct FSoftObjectPath {
   public:
    class FName AssetPathName;    // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash,
...
class FScriptInterface {
   ...
   public:
    class UObject* GetObjectRef() const { return ObjectPointer; }

    void* GetInterfaceRef() const { return InterfacePointer; }
};
...
class TMulticastInlineDelegate {
   public:
    struct InvalidUseOfTMulticastInlineDelegate
        TemplateParamIsNotAFunctionSignature;  // 0x0000(0x0010)(NOT AUTO-GENERATED PROPERTY)
};
...
#define UE_ENUM_OPERATORS(EEnumClass)                                                                                 \
    ...
    inline constexpr EEnumClass operator|(EEnumClass Left, EEnumClass Right) {                                        \
        return (EEnumClass)((std::underlying_type<EEnumClass>::type)(Left) |                                          \
                            (std::underlying_type<EEnumClass>::type)(Right));                                         \
    }                                                                                                                 \
                                                                                                                      \
    inline constexpr EEnumClass& operator|=(EEnumClass& Left, EEnumClass Right) {                                     \
        return (EEnumClass&)((std::underlying_type<EEnumClass>::type&)(Left) |=                                       \
    ...
    inline bool operator&(EEnumClass Left, EEnumClass Right) {                                                        \
        return (((std::underlying_type<EEnumClass>::type)(Left) & (std::underlying_type<EEnumClass>::type)(Right)) == \
                (std::underlying_type<EEnumClass>::type)(Right));                                                     \
    }
...
/*
 * A wrapper for a Byte-Array of padding, that allows for casting to the actual underlaiyng type. Used for undefined
 * structs in cylic headers.
 */
...
/*
 * A wrapper for a Byte-Array of padding, that inherited from UObject allows for casting to the actual underlaiyng type
 * and access to basic UObject functionality. For cyclic classes.
 */
...
using TObjectBasedCycleFixup =
    CyclicDependencyFixupImpl::TCyclicClassFixup<UnderlayingClassType, Size, Align, class UObject>;

template <typename UnderlayingClassType, int32 Size, int32 Align = 0x8>
using TActorBasedCycleFixup =
    CyclicDependencyFixupImpl::TCyclicClassFixup<UnderlayingClassType, Size, Align, class AActor>;
