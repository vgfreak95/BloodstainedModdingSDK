...
enum class LogLevel { Info, Warning, Error, Debug, File };
...
class Logger {
   public:
    ...
    static typename std::enable_if<!std::is_same<std::remove_cv_t<std::remove_pointer_t<T>>, char>::value, void>::type
    Log(T* obj, Args&&... args) {
