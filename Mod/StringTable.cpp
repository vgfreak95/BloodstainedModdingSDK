...
const std::unordered_map<std::string, std::string> PBMasterStringTable = {
  ...
  { "ITEM_NAME_AlluringHorns", "Vampiric Wig" },
  { "ITEM_NAME_MagicalGirlHead", "Miri Wig" },
  { "ITEM_NAME_ShantaeCirclet", "Half-Genie Tiara" },
  { "ITEM_NAME_Kanzashi", "Japanesque Wig" },
  ...
  { "ITEM_NAME_VampiricSkinsuit", "Vampiric Skinsuit" },
  { "ITEM_NAME_MagicalGirlBody", "Miri Dress" },
  { "ITEM_NAME_ShantaeOutfit", "Half-Genie Outfit" },
  { "ITEM_NAME_FestivalKimono", "Japanesque Robe" },
  ...
  { "ITEM_EXPLAIN_AlluringHorns", "Headwear to haunt men's dreams." },
  { "ITEM_EXPLAIN_MagicalGirlHead", "Genki accessories that trail behind Justice Warrior Miri as she battles evil forces." },
  { "ITEM_EXPLAIN_ShantaeCirclet", "The perfect accessory for lethal-looking locks." },
  { "ITEM_EXPLAIN_Kanzashi", "A traditional decorative hairpin." },
  ...
  { "ITEM_EXPLAIN_VampiricSkinsuit", "Armor akin to wearing nothing at all." },
  { "ITEM_EXPLAIN_MagicalGirlBody", "Loli fashion for pretty sailors protecting truth and love, amidst sparkles and rainbows." },
  { "ITEM_EXPLAIN_ShantaeOutfit", "The go-to garb for Guardian Genies." },
  { "ITEM_EXPLAIN_FestivalKimono", "Whether hanging at Hanami or mingling at Matsuri, this high quality robe makes the whole week seem golden." },
  ...
  { "ENEMY_NAME_N0000", "Miriam" },
  { "ENEMY_NAME_N2016", "Breeder" },
  { "ENEMY_NAME_N3125", "Greedling" },
  { "ENEMY_NAME_N2017", "Guardian" },
  { "ENEMY_NAME_N3126", "G. Dullahammer Head" },
  ...
  { "ENEMY_EXPLAIN_N0000", "" },
  { "ENEMY_EXPLAIN_N2016", "Breeder description" },
  { "ENEMY_EXPLAIN_N3125", "Greedling description" },
  { "ENEMY_EXPLAIN_N2017", "Journey Boss description" },
  { "ENEMY_EXPLAIN_N3126", "A dullahammer head that lives on as a separate,\r\nvengeful entity." },
  ...
  { "ITEM_NAME_COL_SwordOfMathildis", "Sword Of Mathildis" },
  { "ITEM_NAME_COL_Zangetsuto", "Sword Of Mathildis" },
  { "ITEM_NAME_COL_Dummy", "" },
  { "ITEM_NAME_COL_Ruby", "Ruby" },
  { "ITEM_NAME_COL_Sapphire", "Sapphire" },
  { "ITEM_NAME_COL_Emerald", "Emerald" },
  { "ITEM_NAME_COL_Diamond", "Diamond" },
  { "ITEM_NAME_COL_Gold", "Gold" },
  { "ITEM_NAME_COL_Orichalcum", "Orichalcum" },
  { "ITEM_NAME_COL_FireflyElixir", "Firefly Elixir" },
  { "ITEM_NAME_COL_Confession", "Confession" },
  ...
  { "ITEM_NAME_MonarchCrown", "Crown of Creation" },
  { "ITEM_NAME_JourneyScarf", "Mystical Scarf" },
  { "ITEM_NAME_ShantaeVest", "Half-Genie Vest" },
  { "ITEM_NAME_ShantaeBandana", "Risky Bandana" },
  { "ITEM_NAME_PirateSword", "Risky Blade" },
  { "ITEM_NAME_PirateGun", "Risky Pistol" },
  { "ITEM_NAME_Wagasa", "Japanesque Umbrella" },
  { "ITEM_NAME_FestivalMask", "Usagi Mask" },
  { "ITEM_NAME_Sarashi", "Sarashi" },
  { "ITEM_NAME_Scythe", "Scythe" },
  { "ITEM_NAME_VampiricChoker", "Vampiric Choker" },
  { "ITEM_NAME_VampiricWings", "Vampiric Wings" },
  { "ITEM_NAME_MagicalScepter", "Miri Scepter" },
  { "ITEM_NAME_MagicalGirlAccessory", "Communicator" },
  ...
  { "ITEM_EXPLAIN_COL_SwordOfMathildis", "<input id=\"Attack\"/> Will certainly attack\r\n<image id=\"Text_Command_Arrow_Right\"/><image id=\"Text_Command_Arrow_Right\"/> + <input id=\"Attack\"/> Defends, then sends damage back" },
  { "ITEM_EXPLAIN_COL_Zangetsuto", "<input id=\"Attack\"/> Slices through evil's veil\r\n<image id=\"Text_Command_Arrow_Right\"/><image id=\"Text_Command_Arrow_Right\"/> + <input id=\"Attack\"/> Counterattacks when assailed" },
  { "ITEM_EXPLAIN_COL_Sword2", "Spend MP for a leaping strike\r\n<input id=\"Ability\"/> <image id=\"Text_Command_Arrow_Plus\"/> <input id=\"Attack\"/>" },
  { "ITEM_EXPLAIN_COL_Ruby", "Red jewels, gifts for ladies most winsome\r\nRubella's strength grows from this stone of... scarlet." },
  { "ITEM_EXPLAIN_COL_Sapphire", "A brilliant blue gem, for ages was rumored\r\nAmong other things, to benefit humors." },
  { "ITEM_EXPLAIN_COL_Emerald", "Deep green gem to enhance an ability\r\nAn entrancing bauble for birds or Capilli." },
  { "ITEM_EXPLAIN_COL_Diamond", "A beautiful stone, forever to keep\r\nPerfect for Pisceans in the waters so deep." },
  { "ITEM_EXPLAIN_COL_Gold", "This rarest of metals is a sight to behold\r\nA surprise to no one, our Robert loves gold!" },
  { "ITEM_EXPLAIN_COL_Orichalcum", "No simple feat, tempering a shard\r\nRequires great skill, and minerals most hard." },
  { "ITEM_EXPLAIN_COL_FireflyElixir", "An odd concoction, aroma most ridiculous\r\nWhatever the taste, favorite of Igniculus." },
  { "ITEM_EXPLAIN_COL_Confession", "One might hide this prayer of truths unsaid\r\nOr one might slip to Johannes instead." },
  ...
  { "ITEM_EXPLAIN_MonarchCrown", "Uses Gold to reduce damage. With proper training,\r\nallows one to secure a distant kingdom." },
  { "ITEM_EXPLAIN_JourneyScarf", "The sacred scarf of a robed figure." },
  { "ITEM_EXPLAIN_ShantaeVest", "Short on length, long on fashion." },
  { "ITEM_EXPLAIN_ShantaeBandana", "A skull cap for your skull cap." },
  { "ITEM_EXPLAIN_PirateSword", "A cursed scimitar suitable for a pirate queen!" },
  { "ITEM_EXPLAIN_PirateGun", "A cursed flintlock pistol once owned by a master pirate." },
  { "ITEM_EXPLAIN_Wagasa", "When closed, a traditional parasol. Hold attack to open, creating a bullet-blocking peril-saw." },
  { "ITEM_EXPLAIN_FestivalMask", "This delicate, hand-crafted mask is sure to attract good favor from yokai and kami alike." },
  { "ITEM_EXPLAIN_Sarashi", "A simple garment worn for support." },
  { "ITEM_EXPLAIN_Scythe", "A curved blade to reap while they sleep." },
  { "ITEM_EXPLAIN_VampiricChoker", "Naughty neckwear for a nubile nape." },
  { "ITEM_EXPLAIN_VampiricWings", "Purely decorative wings. Pair with an impure decolletage." },
  { "ITEM_EXPLAIN_MagicalScepter", "Tap attack to wave this wonderful wand.\r\nHold attack to fire beams of magical light." },
  { "ITEM_EXPLAIN_MagicalGirlAccessory", "This headset helps Miri boldly proclaim her dedication to punish darkness in all its forms." },
  ...
  { "SHARD_NAME_Dreamsteal", "Dream Steal" },
  { "SHARD_NAME_SummonBuChan", "Summon Bu-chan" },
  { "SHARD_NAME_FamiliaBuChan", "Familiar: Bu-chan" },
  { "SHARD_NAME_Fireball", "Half-Genie Fireball" },
  { "SHARD_NAME_FamiliaArcher", "Familiar: Archer" },
  { "SHARD_NAME_FamiliaIgniculus", "Igniculus" },
  { "SHARD_NAME_FamiliaTristis", "Tristis" },
  { "SHARD_NAME_Rubella", "Rubella" },
  { "SHARD_NAME_FamiliaFinn", "Finn" },
  { "SHARD_NAME_Robert", "Robert" },
  { "SHARD_NAME_Oengus", "Oengus" },
  { "SHARD_NAME_Gen", "Gen" },
  { "SHARD_NAME_LightRay", "Light Ray" },
  { "SHARD_NAME_SakuraRain", "Sakura Storm" },
  ...
  { "SHARD_EXPLAIN_Dreamsteal", "Drain energy from deranged enemies." },
  { "SHARD_EXPLAIN_SummonBuChan", "Bu-chan appears in the nick of time to pull Miri out of another jam." },
  { "SHARD_EXPLAIN_FamiliaBuChan", "Miri is joined by her loyal familiar, the powerful but slightly clumsy Bu-chan!" },
  { "SHARD_EXPLAIN_Fireball", "Popular and powerful Sequin Land magic." },
  { "SHARD_EXPLAIN_FamiliaArcher", "Will defend their monarch from distant threats." },
  { "SHARD_EXPLAIN_FamiliaIgniculus", "Summon forth Igniculus to help you." },
  { "SHARD_EXPLAIN_FamiliaTristis", "[transformed by a curse]\r\nSummon forth Tristis to help you." },
  { "SHARD_EXPLAIN_Rubella", "[transformed by a curse]\r\nSend rhythmic blasts of flame toward foes." },
  { "SHARD_EXPLAIN_FamiliaFinn", "[transformed by a curse]\r\nSummon forth Finn to help you." },
  { "SHARD_EXPLAIN_Robert", "[transformed by a curse]\r\nCall forth an ape-like demon and set it upon foes." },
  { "SHARD_EXPLAIN_Oengus", "[transformed by a curse]\r\nIncreases damage from counter attack." },
  { "SHARD_EXPLAIN_Gen", "[transformed by a curse]\r\nRegale your surroundings with a chilling and damaging cry." },
  { "SHARD_EXPLAIN_LightRay", "Hold <input id=\"RT\"/> to target enemies, \r\nrelease to blast them with radiant light." },
  { "SHARD_EXPLAIN_SakuraRain", "Meditate on the transcience of life as enemies are overwhelmed with ailments." },
  ...
  { "SHARD_EFFECT_TXT_Dreamsteal", "Higher recovery amount" },
  { "SHARD_EFFECT_TXT_SummonBuChan", "Increases the duration" },
  { "SHARD_EFFECT_TXT_FamiliaBuChan", "More powerful familiar" },
  { "SHARD_EFFECT_TXT_Fireball", "Increases coverage" },
  { "SHARD_EFFECT_TXT_FamiliaArcher", "More powerful familiar" },
  { "SHARD_EFFECT_TXT_FamiliaIgniculus", "More powerful familiar." },
  { "SHARD_EFFECT_TXT_FamiliaTristis", "More powerful familiar." },
  { "SHARD_EFFECT_TXT_Rubella", "Increases the duration." },
  { "SHARD_EFFECT_TXT_FamiliaFinn", "More powerful familiar." },
  { "SHARD_EFFECT_TXT_Robert", "Increased critical rate." },
  { "SHARD_EFFECT_TXT_Oengus", "Increases damage." },
  { "SHARD_EFFECT_TXT_Gen", "Faster MP recovery." },
  { "SHARD_EFFECT_TXT_LightRay", "Target more enemies" },
  { "SHARD_EFFECT_TXT_SakuraRain", "Increases coverage" },
